...
public class productocontrolador extends HttpServlet {
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (action != null) {
        if (action.equalsIgnoreCase("home")) {
            ...
            if (action.equalsIgnoreCase("Agregar")) {
                ...
                modelo.setStockMinimo(request.getParameter("txtstockminimo"));
                modelo.setNombreProveedor(request.getParameter("cboproveedor"));
                ...
                if (action.equals("nuevo")) {
                    acceso = "vistas/agregarproductos.jsp";
                } else {
                    if (action.equalsIgnoreCase("Modificar")) {
                        modeloproducto modelo = new modeloproducto();
                        modelo.setId(request.getParameter("txtcodigo"));
                        modelo.setNombre(request.getParameter("txtnombre"));
                        modelo.setCosto(request.getParameter("txtcosto"));
                        modelo.setPrecio(request.getParameter("txtprecio"));
                        modelo.setStock(request.getParameter("txtstock"));
    ...
    if (editar != null) {
        request.setAttribute("idproductos", editar);
        acceso = "vistas/modificar_producto.jsp";
    }
