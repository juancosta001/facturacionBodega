<%-- 
    Document   : pagos
    Created on : 3 jul 2024, 21:15:54
    Author     : juana
--%>
            ...
            <div class="formpagos">
                <form action="pagocontrolador" method="post">
                    ...
                    <div class="buttons">
                        ...
                        <button type="submit" name="accion" value="add" class="btn btn-success">NUEVO PAGO</button>
                ...
                <div class="table-responsive">
                    <table class="table table-striped text-center">
                        ...
                        <%                                        pagomodelo modelo = new pagomodelo();
                            List<pagomodelo> listaPagos = modelo.listarPagos();
                        ...
                        <tr>
                            ...
                            <td><%= pago.getIdproveedores()%></td>
                            <td><%= pago.getIdapertura()%></td>
                            <td>
                                <form action="pagocontrolador" method="post">
                                    <input type="hidden" name="id" value="<%= pago.getCodigo()%>">
